...
Структура URL:
    ...
    /api/v1/nutrition/ - Справочники питания (заболевания, аллергии, калькулятор)
...
urlpatterns = [
    ...
    # Справочники питания (заболевания, аллергии, калькулятор калорий)
    # Обрабатывает: справочники для выбора в PetID, расчёт калорийности
    path('api/v1/nutrition/', include('apps.pets.urls_nutrition')),
    ...
    # Обрабатывает: загрузка изображений, видео, файлов в S3, presigned URLs
