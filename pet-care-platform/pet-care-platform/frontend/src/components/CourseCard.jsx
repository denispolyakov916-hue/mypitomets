        ...
        <div className="mt-auto">
          {isOwned ? (
            <button
              ...
              className="w-full h-10 rounded-2xl flex flex-col items-center justify-center bg-secondary-500 hover:bg-secondary-600 text-white transition-all duration-300 active:scale-[0.98]"
            >
