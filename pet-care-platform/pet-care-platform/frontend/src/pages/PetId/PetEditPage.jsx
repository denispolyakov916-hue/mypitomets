...
const AutofillBanner = ({ petName, onDismiss }) => (
  <motion.div
    ...
    exit={{ opacity: 0, y: -20 }}
    className="mb-6 p-4 bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl border border-primary-200"
  >
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Поля с меткой <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-primary-100 text-primary-700 rounded text-xs font-medium">
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
      <div className="flex items-center gap-4">
        {/* Фото */}
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary-100 to-accent-100 
        ...
        {/* Информация */}
        <div className="flex-1">
          <h2 className="section-title mb-0 text-gray-800">{pet.name}</h2>
          ...
          <div className="mt-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-semibold text-primary-600">{displayCompleteness}%</span>
            </div>
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
              <motion.div
                ...
                className={`h-full rounded-full ${
                  ...
                  displayCompleteness >= 50 ? 'bg-yellow-500' : 'bg-accent-500'
                }`}
              />
            </div>
          </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-accent-50 text-accent-600 rounded-xl 
