            ...
            {isOwned ? (
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl font-medium bg-secondary-500 hover:bg-secondary-600 text-white transition-colors flex items-center justify-center gap-2"
                >
