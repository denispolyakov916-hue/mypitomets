/**
 * Мобильные фильтры магазина: нижняя шторка с ручкой, затемнение фона, свайп вниз.
 */
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 border-b border-primary-100 px-4 pb-3">
                <h2 id="shop-filter-sheet-title" className="text-lg font-semibold text-primary-800">
                  Фильтры
                </h2>
                <button
                  type="button"
