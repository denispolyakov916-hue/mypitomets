        ...
        <div className="space-y-0.5">
            ...
            return (
              <div key={category.id}>
                ...
                {hasChildren && isExpanded && (
                  <div className="ml-8 pl-2 border-l-2 border-purple-200 space-y-0.5 py-1 mt-1">
                    <button
          ...
          {(filters.category || filters.category_slug) && (
            <button
              ...
              className="text-xs text-purple-500 hover:text-purple-700 mt-2 flex items-center gap-1"
            >
