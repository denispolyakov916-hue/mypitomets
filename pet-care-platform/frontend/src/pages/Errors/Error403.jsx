...
/**
 * Страница ошибки 403 - Доступ запрещён
 */
const Error403 = () => {
  const navigate = useNavigate()

  const config = {
    imageUrl: 'https://images.unsplash.com/photo-1669822308470-09f3f3e8d4a2?w=640&q=80',
    imageAlt: 'Охранник-питомец',
    homeUrl: '/',
    errorCode: '403',
    title: 'Доступ запрещён',
    description: 'Похоже, у вас недостаточно прав для просмотра этой страницы. Попробуйте войти в систему или обратитесь за помощью.'
  }

  const animations = baseAnimations

  useEffect(() => {
    const title = document.querySelector('.error-403-title')
    if (title) {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="text-center max-w-2xl mx-auto relative z-10">
        ...
        <motion.h2 
          className="text-3xl font-bold text-gray-900 mb-4 animate-title error-403-title"
