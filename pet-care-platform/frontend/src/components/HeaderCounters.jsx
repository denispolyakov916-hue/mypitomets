...
function CounterBadge({ value }) {
	...
	return (
		<span className="absolute -top-1.5 -right-1.5 min-w-[20px] h-[20px] px-1 bg-pink-500 text-white text-[11px] leading-[20px] rounded-full font-semibold text-center shadow-md">
			{text}
		</span>
	)
}

export default function HeaderCounters() {
		...
		<div className="flex items-end gap-6">
			<Link to="/orders" className={itemClass} aria-label="Заказы">
				<div className="relative">
					...
					<CounterBadge value={pendingCount} />
				</div>
