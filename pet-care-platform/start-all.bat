...
:: Запуск бекенда в новом окне
start "ПИТОМЕЦ+ - Бекенд" cmd /k "cd /d "%~dp0backend" && call venv\Scripts\activate.bat && python manage.py migrate --noinput && echo. && echo   Бекенд: http://localhost:8077 && echo   API:    http://localhost:8077/api/ && echo. && python manage.py runserver 0.0.0.0:8077"
